...
class TestTcUbsShmCreate0010(UbsMemCase):
    ...
    PreCondition:
        ...
        P3.UBS-Memory服务加载正常
    TestStep:
        S1.节点0进程0调用接口ubsmem_shmem_allocate region_name shm_name 4*1024*1024 0600 UBSM_FLAG_CACHE(0)
        S2.节点0进程0调用接口ubsmem_shmem_map addr 4*1024*1024 PROT_NONE(0) 1 shm_name 0
        S3.节点0进程1调用接口ubsmem_shmem_map addr 4*1024*1024 PROT_NONE(0) 1 shm_name 0
        S4.两个进程都调用接口ubsmem_shmem_unmap addr 4*1024*1024
    ...
    def test_tc_ubs_shm_create_0010(self):
        shm_name = "TC_UBS_SHM_CREATE_0010"
        size = 4 * 1024 * 1024
        self.logStep(
            "S1.节点0进程0调用接口ubsmem_shmem_allocate region_name shm_name 4*1024*1024 0600 UBSM_FLAG_CACHE(0)")
        ...
        self.logStep("S2.节点0进程0调用接口ubsmem_shmem_map addr 4*1024*1024 PROT_NONE(0) 1 shm_name 0")
        ...
        self.logStep("S3.节点0进程1调用接口ubsmem_shmem_map addr 4*1024*1024 PROT_NONE(0) 1 shm_name 0")
        ...
        self.logStep("S4.两个进程都调用接口ubsmem_shmem_unmap addr 4*1024*1024")
