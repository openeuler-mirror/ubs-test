...
class TestVmFragment013001(OpenStackBaseCase):
    ...
    def test_vm_fragment_014(self, get_topo_path):
        self.logStep("S1、在可视化界面创建8G虚机A")
        self.vm_list = self.prepare_topo(str(get_topo_path("test_vm_fragment_014")))
