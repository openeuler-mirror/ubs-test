...
if __name__ == '__main__':
    ...
    py_mem_borrow_account_array = matrix_mem.matrix_mem_get_all_borrow_memory_account_info()
    print_py_matrix_mem_borrow_account_array(py_mem_borrow_account_array)
