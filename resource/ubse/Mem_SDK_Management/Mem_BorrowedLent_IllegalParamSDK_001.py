...
def print_py_matrix_mem_numa_mem_info(info: PyMatrixMemNumaMemInfo):
    ...
    os.system(f"echo VM Used Memory: {info.vm_used_mem}")
...
def print_py_matrix_mem_numa_info(info: PyMatrixMemNumaInfo):
    os.system(f"echo Global Index: {info.m_global_index}")
    os.system(f"echo Status: {info.m_status}")
    ...
    os.system(f"echo Water Borrow Count: {info.m_water_borrow_count}")
    ...
    os.system(f"echo Last Warning Type: {info.m_last_warning_type}")
    os.system(f"echo Last Warning Count: {info.m_last_warning_count}")
...
if __name__ == '__main__':
    ...
    os.system(f"echo start to get borrowed_and_lent_info")
    py_node_borrowed_and_lent_info = matrix_mem.matrix_mem_get_borrowed_and_lent_info("Node6")

    print_py_matrix_mem_borrowed_and_lent_info_array(py_node_borrowed_and_lent_info)

    py_node_borrowed_and_lent_info = matrix_mem.matrix_mem_get_borrowed_and_lent_info("Node")
